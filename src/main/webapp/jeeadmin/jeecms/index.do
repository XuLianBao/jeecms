...
<head>
    ...
    <link href=static/css/app.menu.css rel=stylesheet>
</head>
<body>
...
<script type=text/javascript src=static/js/manifest.menu.js></script>
<script type=text/javascript src=static/js/vendor.vue.js></script>
<script type=text/javascript src=static/js/app.menu.js></script>
</body>
</html>